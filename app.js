...
const models = ['Mushroom_1', 'Mushroom_2', 'Mushroom_3', 'Mushroom_4', 'Wheat_1', 'Wheat_2', 'Wheat_3', 'Wheat_4', 'Pumpkin_1', 'Pumpkin_2', 'Pumpkin_3', 'Pumpkin_4', 'PalmTree_1', 'PalmTree_2', 'PalmTree_3', 'PalmTree_4']
...
function updateHidingTimer(room){
    room.hidingTime -= TICK_TIME;
    if(room.hidingTime <= 0){
        room.gameStage = STAGE_PLAYING;
    }
}
function updatePlayingTimer(room){
    room.playingTime -= TICK_TIME;
    if(room.playingTime <= 0){
